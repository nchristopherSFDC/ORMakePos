...
public class TimeMatch extends AbstractRUMTimeMatch
{
  ...
  public static String CVS_MODULE_INFO = "OpenRate, $RCSfile: TimeMatch.java,v $, $Revision: 1.6 $, $Date: 2011/09/25 11:36:25 $";
  ...
  */
  ...
  public IRecord procValidRecord(IRecord r)
  {
    ...
    catch (ProcessingException pe)
    {
      ...
      tmpError.setErrorDescription("Time match failed: Rate Plan: " + CurrentRecord.BaseRateplan + " CDR Date: " + CurrentRecord.EventStartDate.toString());
