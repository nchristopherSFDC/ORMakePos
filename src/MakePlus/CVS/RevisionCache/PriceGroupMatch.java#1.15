  ...
  extends AbstractRegexMatch
{
  ...
  public static String CVS_MODULE_INFO = "OpenRate, $RCSfile: PriceGroupMatch.java,v $, $Revision: 1.15 $, $Date: 2011/08/15 17:57:43 $";
  ...
  public IRecord procValidRecord(IRecord r)
  {
    ...
    {        
      ...
      for (Index = 0; Index < CurrentRecord.getChargePacketCount(); Index++)
      {
       ...
       /* if (!(CurrentRecord.NumberType.equals("9999")) & (CurrentRecord.Direction.equals("IN")) & ((tmpCP.PacketType.equals("R")) | (tmpCP.PacketType.equals("W"))))
        {
