 ...
 * target file.
 */
public class RejectFileOutputAdapter
  extends FlatFileOutputAdapter
{
  // this is the CVS version info
  public static String CVS_MODULE_INFO = "OpenRate, $RCSfile: RejectFileOutputAdapter.java,v $, $Revision: 1.1 $, $Date: 2011/08/15 16:16:31 $";

  /**
  * Constructor for SaudiBTBatchOutputAdapter.
  */
  public RejectFileOutputAdapter()
  {
    super();
  }
  ...
  @Override
    public Collection<IRecord> procValidRecord(IRecord r)
    {
      ...
      tmpOutRecord.SetData(tmpInRecord.unmapRecordReject());
