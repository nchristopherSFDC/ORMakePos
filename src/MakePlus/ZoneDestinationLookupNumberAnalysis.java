...
/**
 * This module attempts to retrieve the destination of the event by matching against
 * the origin_map table by type-of-service and BNumberNorm.
 */
public class ZoneDestinationLookupNumberAnalysis extends AbstractBestMatch
{
  // this is the CVS version info
  public static String CVS_MODULE_INFO = "OpenRate, $RCSfile: ZoneDestinationLookupNumberAnalysis.java,v $, $Revision: 1.3 $, $Date: 2011/07/22 08:47:29 $";
